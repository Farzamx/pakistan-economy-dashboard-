...
export const MARKET_IMPACT_SCORE: Record<string, number> = {
  ...
  "sbp-monetary-policy-report": 6,
  "trade-balance": 5,
  "worker-remittances": 5,
  "treasury-bill-auction-3m": 5,
  "pib-auction": 5,
  "sbp-foreign-exchange-reserves": 4,
  "treasury-bill-auction-6m": 4,
  "treasury-bill-auction-12m": 4,
...
const SERIES_TITLE: Record<string, string> = {
  ...
  "sbp-monetary-policy-report": "SBP Monetary Policy Report",
  "trade-balance": "Trade Balance",
  "worker-remittances": "Worker Remittances",
  "treasury-bill-auction-3m": "Treasury Bill Auction (3M)",
  "pib-auction": "PIB Auction",
  "sbp-foreign-exchange-reserves": "SBP Foreign Exchange Reserves",
  "treasury-bill-auction-6m": "Treasury Bill Auction (6M)",
  "treasury-bill-auction-12m": "Treasury Bill Auction (12M)",

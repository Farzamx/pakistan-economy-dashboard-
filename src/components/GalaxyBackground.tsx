// Deterministic pseudo-random generator so star positions are identical
// on the server and client (avoids hydration mismatches that Math.random
// would cause), while still looking randomly scattered.
...
// Three depth layers: more, smaller, dimmer stars "far away" and fewer,
// larger, brighter stars "close up" — gives a sense of depth without any
// scroll/mouse-tracking JS.

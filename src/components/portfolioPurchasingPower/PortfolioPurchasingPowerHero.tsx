...
export default function PortfolioPurchasingPowerHero() {
  return (
    <div className="flex flex-col gap-4 pb-2">
      ...
      >
        <T tKey="portfolioPurchasingPower.cta" />

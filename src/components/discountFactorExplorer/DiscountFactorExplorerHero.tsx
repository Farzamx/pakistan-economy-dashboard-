...
export default function DiscountFactorExplorerHero() {
  return (
    <div className="flex flex-col gap-4 pb-2">
      ...
      >
        <T tKey="discountFactorExplorer.cta" />

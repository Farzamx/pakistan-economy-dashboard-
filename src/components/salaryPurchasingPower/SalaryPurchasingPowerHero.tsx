...
export default function SalaryPurchasingPowerHero() {
  return (
    <div className="flex flex-col gap-4 pb-2">
      ...
      >
        <T tKey="salaryPurchasingPower.cta" />

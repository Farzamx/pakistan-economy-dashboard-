...
export default function InflationDragAnalyzerHero() {
  return (
    <div className="flex flex-col gap-4 pb-2">
      ...
      >
        <T tKey="inflationDragAnalyzer.cta" />

...
export default function SubscriptionForm() {
  ...
  if (phase === "success" || phase === "already-verified") {
    return (
    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-3" noValidate>
      ...
      <div className="flex flex-col gap-3 sm:flex-row">
        ...
        <button
          ...
          className="inline-flex shrink-0 items-center justify-center gap-2 rounded-xl bg-sky-400 px-7 py-3.5 text-base font-semibold text-slate-950 transition-colors hover:bg-sky-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-400 disabled:cursor-not-allowed disabled:opacity-60"
        >

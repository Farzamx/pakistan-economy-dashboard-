 ...
 * Sorted by Market Impact first, then date (see economicEventsRepo.ts's
  ...
  return (
    <section className="glass-card flex flex-col gap-4 rounded-2xl p-6 sm:p-8">
      <div>
        ...
        <p className="mt-1 text-sm text-white/50 light:text-slate-500">Ranked by Market Impact, then by how soon they land.</p>
      </div>
          ...
          >
            <div className="flex flex-1 flex-col gap-1.5">
              ...
              <span className="text-xs text-white/40 light:text-slate-400">
                {formatEventDate(event.eventDate)} · {formatRelativeDay(event.eventDate, today)}
              </span>
            </div>

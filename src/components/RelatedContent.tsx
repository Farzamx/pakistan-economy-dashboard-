...
/** Renders one or more labeled rows of pill-style links — same visual pattern as the existing same-category "Related Comparisons"/"Related Budget Categories" sections, reused here for cross-category links (indicators, provincial pages, budget topics) computed by src/lib/relatedContent.ts. */

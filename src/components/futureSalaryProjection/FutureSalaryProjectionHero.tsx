...
export default function FutureSalaryProjectionHero() {
  return (
    <div className="flex flex-col gap-4 pb-2">
      ...
      >
        <T tKey="futureSalaryProjection.cta" />

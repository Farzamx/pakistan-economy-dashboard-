...
export default function AssetAllocationExplorerHero() {
  return (
    <div className="flex flex-col gap-4 pb-2">
      ...
      >
        <T tKey="assetAllocationExplorer.cta" />

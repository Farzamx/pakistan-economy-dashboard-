...
const RISK_STYLES: Record<string, string> = {
  ...
  Moderate: "text-amber-400/70",
  High: "text-rose-400/70",
};

function impactScoreClass(score: number): string {
  if (score > 0) return "bg-emerald-500/10 text-emerald-400 border-emerald-500/20";
          ...
          return (
            ...
            >
              ...
              {reason && reason !== "Economic impact analysis unavailable." && (
                <p className="text-[10px] leading-relaxed text-white/35 italic">
                  {reason}
                </p>
              )}
